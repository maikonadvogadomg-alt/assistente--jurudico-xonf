...
> Gerado automaticamente pelo SK Code Editor em 15/05/2026, 00:18:30
> **111 arquivo(s)** | **~36.010 linhas de codigo**
...
GET    /download/assistente-juridico.zip  (em server/routes.ts)
...
GET    /api/settings/db-tables  (em server/routes.ts)
...
CUSTOM4_API_KEY=seu_valor_aqui
CUSTOM4_API_URL=seu_valor_aqui
CUSTOM4_API_MODEL=seu_valor_aqui
...
- `server/replit_integrations/image/index.ts` — Ponto de entrada do backend
...
**`app-mobile-preview.tsx`** _(946 linhas)_
...
**`configuracoes.tsx`** _(549 linhas)_
...
**`legal-assistant.tsx`** _(5350 linhas)_
Componente React — parte visual reutilizavel da interface do usuario.
...
Arquivos: 111 | Linhas: ~36.010
Rotas API: 133 endpoint(s) detectado(s)
Variaveis de ambiente necessarias: DATABASE_URL, SESSION_SECRET, PORT, REPLIT_DB_URL, APP_PASSWORD, GEMINI_API_KEY, OPENAI_API_KEY, GROQ_API_KEY, PERPLEXITY_API_KEY, CUSTOM4_API_KEY, CUSTOM4_API_URL, CUSTOM4_API_MODEL, PUBLIC_API_KEY, PUBLIC_API_URL, PUBLIC_API_MODEL, AI_INTEGRATIONS_OPENAI_API_KEY, AI_INTEGRATIONS_OPENAI_BASE_URL, AI_INTEGRATIONS_GEMINI_API_KEY, AI_INTEGRATIONS_GEMINI_BASE_URL, PDPJ_PEM_PRIVATE_KEY, DATAJUD_API_KEY
...
Estrutura principal:
  ...
  client/src/lib/neon-client.ts
  client/src/lib/queryClient.ts
  client/src/lib/utils.ts
  client/src/main.tsx
  client/src/pages/app-mobile-preview.tsx
...
*Plano gerado pelo SK Code Editor — 15/05/2026, 00:18:30*